...
sudo insmod intercept.ko\
    defaultPageFaultAddress=$ADDR_PAGE_FAULT\
    defaultDoPageFaultAddress=$ADDR_DO_PAGE_FAULT\
    pv_IRQ_OPS=$ADDR_PV_IRQ_OPS\
    errorEntryAddress=$ADDR_ERROR_ENTRY\
    errorExit=$ADDR_ERROR_EXIT
